  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/img.jpg" width=100 height=100 alt="B Manikanta Tarun" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://my.manikantadev.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">B Manikanta Tarun</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 6300346594</h4>
		<h4 style="font-family:'typo' ">manikantatarun000@gmail.com</h4>
		<h4 style="font-family:'typo' ">Aditya Degree College, Vizianagaram</h4></div></div>
		</p>
      </div>
